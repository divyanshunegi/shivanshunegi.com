      ...
      services: [
        {
          ...
          description:
            'High-impact commercial videos that tell your brand story.',
          items: ['Product Showcases', 'Brand Stories', 'TV Commercials'],
        },
        {
          title: 'Music Videos',
          description:
            'Creative music videos that capture the essence of your sound.',
          items: [
            'Artistic Direction',
            'Visual Effects',
            'Performance Capture',
        ...
        },
        {
          title: 'Documentaries',
          description:
            'Compelling documentary films that share important stories.',
      ...
      services: [
        {
          ...
          description:
            'Strategic content to attract and convert potential clients.',
          items: [
            'Campaign Strategy',
            'Content Calendar',
            'Analytics Tracking',
        ...
        },
        {
          ...
          description:
            'Innovative AI-powered content creation for social media.',
  ...
  return (
    <main className='min-h-screen bg-white dark:bg-gray-900'>
      ...
      <div className='pt-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16'>
        ...
        >
          Elevate your brand with tailored solutions designed to help you stand
          out
        </motion.p>
        ...
        >
          {serviceCategories.map((category, categoryIndex) => (
            <motion.div
              ...
              className='bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-lg'
            >
              <div className='p-6'>
                  ...
                  {category.services.map((service, serviceIndex) => (
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        animate={{
                          opacity:
                            hoveredService?.category === categoryIndex &&
                            hoveredService?.service === serviceIndex
                              ? 1
                              : 0,
                          height:
                            hoveredService?.category === categoryIndex &&
